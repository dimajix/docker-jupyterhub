...
#  Default: 'http://:8000'
c.JupyterHub.bind_url = '[% HUB_PROXY_URL %]'
...
c.JupyterHub.config_file = '/etc/jupyter/jupyterhub_config.py'
...
#  .. versionadded:: 0.9
#  Default: ''
c.JupyterHub.hub_bind_url = 'http://[% HUB_CONNECT_IP %]:[% HUB_CONNECT_PORT %]'
...
#  .. versionadded:: 0.9
#  Default: ''
c.JupyterHub.hub_connect_url = 'http://[% HUB_CONNECT_IP %]:[% HUB_CONNECT_PORT %]'
...
#  Default: '127.0.0.1'
c.JupyterHub.hub_ip = '[% HUB_BIND_IP %]'
...
c.JupyterHub.hub_port = [% HUB_BIND_PORT %]
