...
c.JupyterHub.db_kwargs = {[% HUB_DB_OPTS %]}

## url for the database. e.g. `sqlite:///jupyterhub.sqlite`
c.JupyterHub.db_url = '[% HUB_DB_URI %]'
...
#  
#  .. versionadded:: 0.8
c.JupyterHub.hub_connect_ip = '[% HUB_CONNECT_ADDRESS %]'
...
#  differ.
c.JupyterHub.hub_ip = '[% HUB_API_ADDRESS %]'

## The port for the Hub process
c.JupyterHub.hub_port = [% HUB_API_PORT %]

## The public facing ip of the whole application (the proxy)
c.JupyterHub.ip = '[% HUB_PROXY_ADDRESS %]'
...
c.JupyterHub.port = [% HUB_PROXY_PORT %]
...
notebook_root = os.environ['JUPYTER_NOTEBOOK_DIR']
notebook_dir = os.path.join(notebook_root,'{username}')
notebook_volume = os.environ['JUPYTER_NOTEBOOK_VOLUME']
c.DockerSpawner.notebook_dir = notebook_dir
c.DockerSpawner.volumes = { notebook_volume: notebook_root }
c.DockerSpawner.environment.update({'JUPYTER_NOTEBOOK_DIR':notebook_root})

## Path to SSL certificate file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_key
c.JupyterHub.ssl_cert = os.environ['HUB_SSL_CERT']

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = os.environ['HUB_SSL_KEY']
